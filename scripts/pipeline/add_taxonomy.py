...
add_taxonomy.py
---------------
Joins trnascan_GTDB_r226_v2_final.csv with GTDB r226 taxonomy, adding one column
per taxonomic rank (domain → species) to the full ~6M-row table.

Output: /data/roma/trnascan_GTDB_r226_v2_final_matched_taxonomy.csv
"""
...
parser.add_argument("csv", nargs="?", default=f"{DATA_ROOT}/trnascan_GTDB_r226_v2_final.csv",
                    help="Input trnascan CSV (default: trnascan_GTDB_r226_v2_final.csv)")
