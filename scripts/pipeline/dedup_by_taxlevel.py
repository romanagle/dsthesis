...
Input:  trnascan_GTDB_r226_v2_final_matched_taxonomy.csv, read in chunks)
Output: data/tax_level_dedup/dedup_{level}.csv  (one file per level)
...
parser.add_argument(
    "--input", default=f"{DATA_ROOT}/trnascan_GTDB_r226_v2_final_matched_taxonomy.csv",
    help="Path to taxonomy-enriched tRNAscan CSV"
)
parser.add_argument(
    "--outdir", default=f"{DATA_ROOT}/data/dedup",
